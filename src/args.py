...
def parse_arguments():
    ...
    parser.add_argument("--name", type=str, default="607:5adapter-heads-hard-lr", help="Experiment id.")
    parser.add_argument(
        "--log-dir",
        type=str,
        default="outputs/",
    ...
    parser.add_argument("--set", type=str, default='SplitImageNet', choices=['SplitImageNet'], help="Which dataset to use")
